...
#       StudentID: 832391
#        version: 3 final product stage4
======================================================================*/
...
/* prints out structure of data for stage 4, and populates arrays for use  using new centroid*/
void
stage_4(double X[], double Y[], double KG[], int valid_lines) {
    ...
    pop_arrays(X, Y, KG, STAGE_4, valid_lines, dist, ran, batt_out, batt_ret, time, trip_batt);
    ...
    printf("S%d, centroid x = %lf y = %lf\n", STAGE_4, cent_x, cent_y);
*/
    ...
    optimise(valid_lines, trip_batt, dist, ran, batt_out, batt_ret, time, STAGE_4);
