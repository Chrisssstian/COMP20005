...
void do_stage4(records_t records[], int valid_lines, int year, int stage, double *mean);
...
void print_stage(double rainfallarray[], int i, int count, int start_year, int end_year, int stage);
...
stage_4(records_t records[], int valid_lines, int year) {
    //check_month(records, valid_lines, STAGE_4, mean);
    double mean[MONTHS];
    mean_array(records, valid_lines, mean);
...
void
do_stage4(records_t records[], int valid_lines, int year, int stage, double *mean) {
...
void
mean_array(records_t records[], int valid_lines, double *mean) {
    int i, j, k, count[MONTHS];
    double rainfallarray[valid_lines];
...
print_stage(double rainfallarray[], int i, int count, int start_year,
    ...
    if (stage == STAGE_2) {
        ...
        if (count != 0 ) {
            med_calc = mean_rainfall(rainfallarray, count);
